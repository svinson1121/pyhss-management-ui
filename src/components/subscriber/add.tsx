...
// Shared dark-theme dropdown paper for all Autocomplete fields in this form
...
// Shared sx for the TextField inside each Autocomplete
const autoInputSx = {
            ...
            <Grid item xs={4}>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label={`${i18n.t('inputFields.header.defaultAPN')} ${errors.default_apn}`}
