  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell>{row.sgw_address || <span style={{fontSize:'11px', color:'var(--accent)', fontStyle:'italic', opacity:0.8}}>DNS Resolved</span>}</TableCell>
        <TableCell>{row.pgw_address || <span style={{fontSize:'11px', color:'var(--accent)', fontStyle:'italic', opacity:0.8}}>DNS Resolved</span>}</TableCell>
        <TableCell>
